...
public class HelloSchedules {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    /*
     * Register the workflow activity implementation with the worker. 
     * Since workflow activities are stateless and thread-safe, we need to register a shared instance.
     */
    ...
    ScheduleHandle handle =
        scheduleClient.createSchedule(SCHEDULE_ID, 
                schedule, 
